...
INSERT INTO photo (file_name, file_url, uploaded_date, user_id) VALUES
    ('', 'https://astrophotographylens.com/cdn/shop/articles/astrophotography-for-beginners_b75c2337-0633-473c-a3ae-c946c921d3a2.jpg?v=1686234434&width=1000', now(), 1);

INSERT INTO photo (file_name, file_url, uploaded_date, user_id) VALUES
    ('', 'https://cdn.mos.cms.futurecdn.net/DMLwZCcWy25RhSYoszqsjN.jpg', now()-1, 2);

INSERT INTO photo (file_name, file_url, uploaded_date, user_id) VALUES
    ('', 'https://i.natgeofe.com/n/e98767f7-9d53-4bef-a4d1-4d94377f7848/44917.jpg', now()-2, 1);

INSERT INTO photo (file_name, file_url, uploaded_date, user_id) VALUES
    ('', 'https://img.freepik.com/free-photo/beautiful-shot-night-sky-with-breathtaking-spinning-stars_181624-4268.jpg', now()-3, 1);

INSERT INTO photo (file_name, file_url, uploaded_date, user_id) VALUES
    ('', 'https://exoplanets.nasa.gov/internal_resources/698/', now()-4, 2);

INSERT INTO photo (file_name, file_url, uploaded_date, user_id) VALUES
    ('', 'https://cdn.mos.cms.futurecdn.net/HsDtpFEHbDpae6wBuW5wQo.jpg', now()-5, 2);

INSERT INTO photo (file_name, file_url, uploaded_date, user_id) VALUES
    ('', 'https://source.washu.edu/app/uploads/2015/12/6988808-cosmic-quasar.jpg', now()-6, 2);